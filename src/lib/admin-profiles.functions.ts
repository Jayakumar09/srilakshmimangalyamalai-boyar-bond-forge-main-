...
const fieldSchema = z.object({
  ...
  gothram: z.string().optional().nullable(),
  ...
  education_detail: z.string().optional().nullable(),
  profession: z.string().optional().nullable(),
  job_detail: z.string().optional().nullable(),
  ...
  siblings: z.string().optional().nullable(),
  brothers: z.coerce.number().int().min(0).optional().nullable(),
  sisters: z.coerce.number().int().min(0).optional().nullable(),
  family_details: z.string().optional().nullable(),
  pref_age_min: z.coerce.number().optional().nullable(),
  pref_age_max: z.coerce.number().optional().nullable(),
  pref_height_min_cm: z.coerce.number().optional().nullable(),
  pref_marital_status: z.string().optional().nullable(),
  pref_sub_caste: z.string().optional().nullable(),
  pref_education: z.string().optional().nullable(),
  pref_profession: z.string().optional().nullable(),
  pref_district: z.string().optional().nullable(),
